...
namespace Demo.BLL.MappingProfiles
{
    public class MappingProfiles:Profile
    {
        public MappingProfiles()
        {
            ...
            .ReverseMap();
            CreateMap<CreatedEmployeeDto, Employee>().ForMember(dest => dest.HiringDate, option => option.MapFrom(src => src.HiringDate.ToDateTime(new TimeOnly())));/*.ForMember(dest => dest.ImageName, option => option.MapFrom(src => src.HiringDate.ToDateTime(new TimeOnly())));*/
